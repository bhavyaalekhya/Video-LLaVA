...
def main():
    # technique error
    tech_pred = error_category('Technique Error', '/videollava_metrics/technique_error.txt')

    # measurement error
    me_pred = error_category('Measurement Error', '/videollava_metrics/measurement_error.txt')

    # missing error
    mi_pred = error_category('Missing Error', '/videollava_metrics/missing_error.txt')

    # order error
    o_pred = error_category('Order Error', '/videollava_metrics/order_error.txt')

    # preparation error
    p_pred = error_category('Preparation Error', '/videollava_metrics/preparation_error.txt')

    # temperature error
    temp_pred = error_category('Temperature Error', '/videollava_metrics/temperature_error.txt')

    # timing error
    ti_error = error_category('Timing Error', '/videollava_metrics/timing_error.txt')
